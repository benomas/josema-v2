    ...
    <div class="col-sm-12">
        ...
        <div class="col-xs-12" >
            <div class="embed-responsive sombraiframe embed-responsive-16by9">
                <iframe v-bind:src="'http://player.vimeo.com/video/'+activity.activity.vimeo_code" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
        </div>
    </div>
</template>
